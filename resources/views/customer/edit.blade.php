...
@section('main')
    ...
    @endif
    <form method="POST" action="{{ route('update', $customer->id) }}" class="container col-6" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row  align-items-center mt-1">
            ...
            <div class="col-auto col-6">
                <input type="text" id="image" name="image" value="{{ old('image', $customer->image) }}"
                    class="form-control">
                @error('image')
                    <small class="text-danger">{{ $message }} </small>
                @enderror
        ...
        <div class="row  align-items-center mt-1">
            ...
            <div class="col-auto col-6">
                <textarea class="form-control" name="bio" id="" rows="3">{{ old('bio', $customer->bio) }}</textarea>
            </div>
        </div>
